...
- **Versatile Usage**: Can be used for trading, staking, or as collateral in DeFi applications.  
- **Interoperable**: Supports swaps and transfers across supported bridges and networks (e.g., Ethereum, Base).
